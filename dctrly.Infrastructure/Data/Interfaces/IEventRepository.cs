...
public interface IEventRepository
{
    ...
    /// An optional filter to search for events by their title. Only events containing this string in their title will be included.
    /// </param>
    /// <param name="descriptionFilter">
    /// An optional filter to search for events by their description. Only events containing this string in their description will be included.
    /// </param>
    /// <param name="dateFromFilter">
    /// An optional filter specifying the earliest end date of the events to include.
    /// </param>
    /// <param name="dateToFilter">
    /// An optional filter specifying the latest start date of the events to include.
    /// </param>
